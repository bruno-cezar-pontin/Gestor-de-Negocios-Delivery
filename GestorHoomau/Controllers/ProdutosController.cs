...
namespace GestorHoomau.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Valor,Qtd")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Nome,Valor,Qtd")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
